...
TEST_CASE("exactly test", "[argon][constraints][exactly]") {
    ...
    SECTION("exactly one") {
        const std::string msg = "exactly one required";
        cmd.constraints.require(argon::exactly(1, int_handle, str_handle, pos_handle), msg);
        argon::Cli cli{cmd};
    ...
    SECTION("exactly two") {
        const std::string msg = "exactly two required";
        cmd.constraints.require(argon::exactly(2, int_handle, str_handle, pos_handle), msg);
        argon::Cli cli{cmd};
    ...
    SECTION("exactly three") {
        const std::string msg = "exactly three required";
        cmd.constraints.require(argon::exactly(3, int_handle, str_handle, pos_handle), msg);
        argon::Cli cli{cmd};
